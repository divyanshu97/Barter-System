<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Materialize.aspx.cs" Inherits="Materialize" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <nav>
                <div class="nav-wrapper">
                    <ul>
                        <li class="active"><a href="Materialize.aspx" style="font-size: medium">PROFILE</a></li>
