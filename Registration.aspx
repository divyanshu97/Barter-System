                    ...
                    <div class="signup-form">
                        <h2>SIGN UP</h2>
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="tbxName" class="form-control" input type="text" runat="server" placeholder="Enter Name"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="tbxEmail" class="form-control" input type="email" runat="server" placeholder="Enter Email"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="tbxPassword" class="form-control" input type="password" runat="server" placeholder="Enter Password"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="tbxCity" class="form-control" input type="text" runat="server" placeholder="Enter City"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="tbxPhone" class="form-control" input type="text" runat="server" placeholder="Enter Phone"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="tbxDob" class="form-control" input type="date" runat="server"></asp:TextBox>
                            ...
                            <div class="signup_text">
                                Have an account?
                                <asp:LinkButton ID="lnkLogin" class="login" style="display: inline; padding-left: 5px;" runat="server" Text="LOGIN" OnClick="lnkLogin_Click"></asp:LinkButton>
